...
const testimonialsSlider = new Swiper('.testimonials-karousel__items', {
  slidesPerView: 1,
  spaceBetween: gap,
  loop: true,
  navigation: {
    nextEl: '.testimonials-karousel__next',
    prevEl: '.testimonials-karousel__prev',
  },
});

const heroSlider = new Swiper('.hero-section__items', {
  slidesPerView: 1,
  // spaceBetween: gap,
  loop: true,
  navigation: {
